   ...
   , mActiveMap("")
{
   ...
   mCenterOnSelectionPtr = new wkf::Action(QString(u8"选中居中"), this, QKeySequence(Qt::ALT + Qt::Key_Home));
   mCenterOnScenarioPtr  = new wkf::Action(QString(u8"想定居中"), this, QKeySequence(Qt::Key_Home));
