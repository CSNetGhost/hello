   ...
   : PrefWidgetT<InteractionPrefObject>()
{
   ...
   QTreeWidgetItem* lw = new QTreeWidgetItem(mUi.treeWidget->invisibleRootItem(), QStringList(u8"线宽"));
   ...
   QTreeWidgetItem* standard = new QTreeWidgetItem(mUi.treeWidget->invisibleRootItem(), QStringList(u8"标准"));
   mItemMap[InteractionPrefData::cDETECT]     = new QTreeWidgetItem(standard, QStringList(u8"探测"));
   mItemMap[InteractionPrefData::cTRACK]      = new QTreeWidgetItem(standard, QStringList(u8"传感器跟踪"));
   mItemMap[InteractionPrefData::cLOCALTRACK] = new QTreeWidgetItem(standard, QStringList(u8"本地跟踪"));
   mItemMap[InteractionPrefData::cFIRE]       = new QTreeWidgetItem(standard, QStringList(u8"开火"));
   mItemMap[InteractionPrefData::cKILL]       = new QTreeWidgetItem(standard, QStringList(u8"杀伤*"));
   mItemMap[InteractionPrefData::cJAM]        = new QTreeWidgetItem(standard, QStringList(u8"干扰请求"));
   mItemMap[InteractionPrefData::cMESSAGE]    = new QTreeWidgetItem(standard, QStringList(u8"通信*"));
   mItemMap[InteractionPrefData::cTASK]       = new QTreeWidgetItem(standard, QStringList(u8"任务"));
   standard->setExpanded(true);
   QTreeWidgetItem* tt = new QTreeWidgetItem(mUi.treeWidget->invisibleRootItem(), QStringList(u8"提示"));
   mTooltipWidget      = new QComboBox(this);
   mTooltipWidget->addItem(u8"关", InteractionPrefData::cTT_OFF);
   mTooltipWidget->addItem(u8"简单", InteractionPrefData::cTT_SIMPLE);
   mTooltipWidget->addItem(u8"详细", InteractionPrefData::cTT_DETAILED);
   mUi.treeWidget->setItemWidget(tt, 1, mTooltipWidget);
   QTreeWidgetItem* to = new QTreeWidgetItem(mUi.treeWidget->invisibleRootItem(), QStringList(u8"*超时 (秒)"));
   ...
   QTreeWidgetItem* sl    = new QTreeWidgetItem(mUi.treeWidget->invisibleRootItem(), QStringList(u8"*允许堆栈"));
