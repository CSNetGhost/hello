...
WKF_PLUGIN_DEFINE_SYMBOLS(OSMConverter::Plugin, u8"OSM转换", u8"将 OSM 路线转换为带有辅助数据的 AFSIM 路线", "wizard")
   ...
   , mDialog(new OSMConverterDialog(wkfEnv.GetMainWindow()))
{
   ...
   wkf::Action* startAction = new wkf::Action(QIcon::fromTheme("osm_converter"), "OSM 转换器...", mainWindowPtr);
