...
std::array<const char*, TypeBrowser::Model::cTYPE_KIND_COUNT> cTYPE_KIND_NAMES = {
                                                                                    u8"平台",          // "Platform"
                                                                                    u8"处理器",        // "Processor"
                                                                                    u8"武器",          // "Weapon"
                                                                                    u8"通信设备",      // "Comm"
                                                                                    ...
                                                                                    u8"运动机构",      // "Mover"
                                                                                    u8"燃料",          // "Fuel"
                                                                                    u8"武器效应",      // "Weapon Effects"
                                                                                    u8"路由网络",      // "Route Network"
                                                                                    u8"路由",          // "Route"
                                                                                    u8"航空器",        // "Aero"
                                                                                    u8"区域",          // "Zone"
                                                                                    u8"天线模式",      // "Antenna Pattern"
                                                                                    u8"声学特征",      // "Acoustic Signature"
                                                                                    u8"红外特征",      // "Infrared Signature"
                                                                                    u8"光学特征",      // "Optical Signature"
                                                                                    u8"雷达特征",      // "Radar Signature"
                                                                                    u8"固有对比度",    // "Inherent Contrast"
                                                                                    u8"掩蔽模式",      // "Masking Pattern"
                                                                                    u8"反射率",        // "Reflectivity"
                                                                                    u8"电子战效应",    // "EW Effect"
                                                                                    u8"电子攻击技术",  // "EA Technique"
                                                                                    u8"电子防护技术",  // "EP Technique"
                                                                                    u8"电子攻击",      // "Electronic Attack"
                                                                                    u8"电子防护"       // "Electronic Protect"
};
