   ...
   , mStartTimeWidgetPtr(new StartTimeWidget(this))
{
   ...
   mUI.mTabWidget->addTab(mInserterWidgetPtr, u8"插入卫星");
   mUI.mTabWidget->addTab(mTLE_WidgetPtr, u8"更新 TLEs");
   mUI.mTabWidget->addTab(mStartTimeWidgetPtr, u8"编辑开始时间");
   ...
   connect(mUI.mShowPreferencesButton,
           &QPushButton::clicked,
           this,
           []() { wkfEnv.GetMainWindow()->ShowPreferencePage(u8"太空工具"); });
