...
WKF_PLUGIN_DEFINE_SYMBOLS(SpaceTools::Plugin,
                          u8"太空工具",
                          u8"提供了用于创建空间场景的工具，例如“星座生成器”和“星盘”.",
                          "wizard")
...

{
   ...
   mSatelliteActionPtr = new wkf::Action(QIcon::fromTheme("satellite"), u8"卫星构建器", wkfEnv.GetMainWindow());
   ...
   QMenu* tMenuPtr = wkfEnv.GetMainWindow()->GetMenuByName(u8"工具");
   if (tMenuPtr)
   {
