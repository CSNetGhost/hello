...
void SimulationManager::PrefWidget::PopulateAppDetails(SimItem* aItem)
{
   ...
   QTableWidgetItem* nameLabel = new QTableWidgetItem(QString::fromUtf8(u8"名称"));
   nameLabel->setFlags(nameLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* pathLabel = new QTableWidgetItem(QString::fromUtf8(u8"路径"));
   pathLabel->setFlags(pathLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* versionLabel = new QTableWidgetItem(QString::fromUtf8(u8"版本"));
   versionLabel->setFlags(versionLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* exeLabel = new QTableWidgetItem(QString::fromUtf8(u8"文件名"));
   exeLabel->setFlags(exeLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* dateLabel = new QTableWidgetItem(QString::fromUtf8(u8"修改日期"));
   dateLabel->setFlags(dateLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* profilingOutLabel = new QTableWidgetItem(QString::fromUtf8(u8"性能分析输出路径"));
   profilingOutLabel->setFlags(profilingOutLabel->flags() & ~Qt::ItemIsEditable);

   QTableWidgetItem* commandLineParamLabel = new QTableWidgetItem(QString::fromUtf8(u8"额外参数（高级）"));
