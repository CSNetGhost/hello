   ...
   , mDebuggerPtr(nullptr)
{
   ...
   mRunAction = new wkf::Action(QIcon::fromTheme("run"), QString::fromUtf8(u8"运行"), this, QKeySequence("F5"));
   mRunAction->setEnabled(false);
   mDebugAction = new wkf::Action(QIcon::fromTheme("run_debug"), QString::fromUtf8(u8"调试运行"), this, QKeySequence("Ctrl+F5"));
   mDebugAction->setEnabled(false);

   mContinueRealtimeAction =
      new wkf::Action(QIcon::fromTheme("play"), QString::fromUtf8(u8"实时继续"), this, QKeySequence("Ctrl+F5"));
   mContinueRealtimeAction->setEnabled(false);
   mContinueRealtimeAction->setVisible(false);
   mContinueNonRealtimeAction =
      new wkf::Action(QIcon::fromTheme("fast_forward"), QString::fromUtf8(u8"非实时继续"), this, QKeySequence("F5"));
   ...
   mPauseAction = new wkf::Action(QIcon::fromTheme("pause"), QString::fromUtf8(u8"全部暂停"), this, QKeySequence("Pause"));
   mPauseAction->setEnabled(false);
   mPauseAction->setVisible(false);
   mStopAction = new wkf::Action(QIcon::fromTheme("stop"), QString::fromUtf8(u8"停止调试"), this, QKeySequence("Shift+F5"));
   mStopAction->setEnabled(false);
   mStopAction->setVisible(false);
   mRestartAction =
      new wkf::Action(QIcon::fromTheme("restart"), QString::fromUtf8(u8"重新运行"), this, QKeySequence("Ctrl+Shift+F5"));
   ...
   mStepIntoAction = new wkf::Action(QIcon::fromTheme("step_into"), QString::fromUtf8(u8"步入"), this, QKeySequence("F11"));
   mStepIntoAction->setEnabled(false);
   mStepIntoAction->setVisible(false);
   mStepOverAction = new wkf::Action(QIcon::fromTheme("step_over"), QString::fromUtf8(u8"步过"), this, QKeySequence("F10"));
   mStepOverAction->setEnabled(false);
   mStepOverAction->setVisible(false);
   mStepOutAction = new wkf::Action(QIcon::fromTheme("step_out"), QString::fromUtf8(u8"步出"), this, QKeySequence("Shift+F11"));
   mStepOutAction->setEnabled(false);
   mStepOutAction->setVisible(false);

   mToggleBreakpointAction =
      new wkf::Action(QIcon::fromTheme("stop_sign"), QString::fromUtf8(u8"切换断点"), this, QKeySequence("F9"));
   mDeleteAllBreakpointsAction = new wkf::Action(QString::fromUtf8(u8"删除所有断点"), this, QKeySequence("Ctrl+Shift+F9"));
   mDisableAllBreakpointsAction = new wkf::Action(QString::fromUtf8(u8"禁用所有断点"), this, Qt::WindowShortcut);

   mDebugSettings = new wkf::Action(QString::fromUtf8(u8"调试器设置..."), this, Qt::WindowShortcut);
   ...
   QMenu* runMenu = mainWindowPtr->FindOrCreateMenu(QString::fromUtf8(u8"运行"));
...
{
   wkfEnv.GetMainWindow()->ShowPreferencePage(QString(u8"仿真执行"));
}
