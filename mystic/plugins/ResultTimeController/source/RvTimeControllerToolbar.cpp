   ...
   , mPressed(false)
{
   ...
   mAdvanceTimeActionPtr = new wkf::Action(QIcon::fromTheme("time"), u8"跳转至时间", aInterfacePtr);
   addAction(mAdvanceTimeActionPtr);
   mFastForwardActionPtr = new wkf::Action(QIcon::fromTheme("fast_forward"), u8"设置时钟频率", aInterfacePtr);
   ...
   mRestartActionPtr =
      new wkf::Action(QIcon::fromTheme("restart"), u8"重新开始", aInterfacePtr, QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_F5));
   ...
   mReverseActionPtr = new wkf::Action(QIcon::fromTheme("reverse"), u8"倒退", aInterfacePtr);
   ...
   mPauseActionPtr = new wkf::Action(QIcon::fromTheme("pause"), u8"暂停", aInterfacePtr);
   ...
   mResumeActionPtr = new wkf::Action(QIcon::fromTheme("play"), u8"恢复", aInterfacePtr);
   ...
   mPrevBookmarkActionPtr =
      new wkf::Action(QIcon::fromTheme("skip_last"), u8"上一个书签”", this, QKeySequence(Qt::Key_Less));
   ...
   mNextBookmarkActionPtr =
      new wkf::Action(QIcon::fromTheme("skip_next"), u8"下一个书签”", this, QKeySequence(Qt::Key_Greater));
