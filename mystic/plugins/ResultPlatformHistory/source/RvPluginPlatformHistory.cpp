   ...
   , mWingRibbonRangeLoaded(0.0, 0.0)
{
   ...
   QTreeWidgetItem* parent = RegisterOptionGroup(nullptr, u8"历史");
   mTraceLineType          = RegisterOption(parent, u8"轨迹线")->type();
   mWingRibbonType         = RegisterOption(parent, u8"翼带")->type();
}
