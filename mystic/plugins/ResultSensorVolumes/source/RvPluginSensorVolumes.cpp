...
WKF_PLUGIN_DEFINE_SYMBOLS(RvSensorVolumes::Plugin, u8"传感器体积", u8"支持绘制传感器体积的插件", "mystic")
   ...
   , mIndividualIndex(0)
{
   ...
   mSensorTopItem = RegisterOption(nullptr, u8"传感器体积");
   mWeaponTopItem = RegisterOption(nullptr, u8"干扰机体积");
