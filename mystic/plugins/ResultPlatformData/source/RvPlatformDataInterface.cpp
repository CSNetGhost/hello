...
{
   mSideUpdater   = wkfEnv.GetUpdater(u8"阵营", aPlatformName);
   mTypeUpdater   = wkfEnv.GetUpdater(u8"类型", aPlatformName);
   mIconUpdater   = wkfEnv.GetUpdater(u8"图标", aPlatformName);
   mDomainUpdater = wkfEnv.GetUpdater(u8"空间域", aPlatformName);
   mStatusUpdater = wkfEnv.GetUpdater(u8"状态", aPlatformName);
