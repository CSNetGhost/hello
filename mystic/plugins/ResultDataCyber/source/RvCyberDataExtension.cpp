...
std::vector<std::unique_ptr<rv::DataExtension::StateCard>> rv::CyberDataExtension::GetStateCardList() const
{
   ...
   list.emplace_back(ut::make_unique<rv::DataExtension::StateCard>(QString::fromUtf8(u8"赛博侦测"), ":/icons/detect.png", QString::fromUtf8(u8"赛博")));
   list.emplace_back(ut::make_unique<rv::DataExtension::StateCard>(QString::fromUtf8(u8"赛博免疫"), ":/icons/immune.png", QString::fromUtf8(u8"赛博")));
   list.emplace_back(ut::make_unique<rv::DataExtension::StateCard>(QString::fromUtf8(u8"赛博失陷"), ":/icons/vulnerable.png", QString::fromUtf8(u8"赛博")));
   list.emplace_back(ut::make_unique<rv::DataExtension::StateCard>(QString::fromUtf8(u8"赛博损伤"), ":/icons/damage.png", QString::fromUtf8(u8"赛博")));
   return list;
}
...
std::vector<std::unique_ptr<rv::DataExtension::Interaction>> rv::CyberDataExtension::GetInteractionList() const
{
   ...
   list.emplace_back(
      ut::make_unique<rv::DataExtension::Interaction>(QString::fromUtf8(u8"赛博归因"), QString::fromUtf8(u8"赛博"), "cyber-attributed", QColor(0, 255, 255)));
   list.emplace_back(
      ut::make_unique<rv::DataExtension::Interaction>(QString::fromUtf8(u8"赛博扫描"), QString::fromUtf8(u8"赛博"), "cyber-scans", QColor(0, 255, 192)));
   list.emplace_back(
      ut::make_unique<rv::DataExtension::Interaction>(QString::fromUtf8(u8"赛博攻击"), QString::fromUtf8(u8"赛博"), "cyber-attacks", QColor(255, 143, 143)));
   return list;
}
